...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Додати зображення до варіанта продукту' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Зображення додано' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Отримати всі зображення для конкретного варіанта' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Отримати конкретне зображення' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Оновити зображення' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Видалити зображення' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
